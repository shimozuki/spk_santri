...
<div class="mb-4">
    ...
    <div class="row">
        ...
        <div class="container d-flex justify-content-center align-self-center p-5">
            <h3 class="font-weight-bold text-center">Selamat Datang {{ Auth::user()->name }} Di Aplikasi Sistem Pendukung Keputusan Lulusan Santri
                Menggunakan
        ...
        @else
        <div class="container d-flex justify-content-center align-self-center p-5">
            <h4 class="font-weight-bold text-center">Selamat Datang {{ Auth::user()->name }} Di Aplikasi Sistem Pendukung Keputusan Lulusan Santri
                <br>

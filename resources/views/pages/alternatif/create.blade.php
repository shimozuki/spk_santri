                            ...
                            <form action="{{ route('alternatif.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-12 col-lg-4">
                                        ...
                                        <input type="file" name="pas_foto" id="pas_foto"
                                            class="form-control-file @error('pas_foto') is-invalid @enderror" required>
                                        @error('pas_foto')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-12 col-lg-4">
                                        ...
                                        <input type="file" name="foto_ktp" id="foto_ktp"
                                            class="form-control-file @error('foto_ktp') is-invalid @enderror" required>
                                        @error('foto_ktp')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-12 col-lg-4">
                                        ...
                                        <input type="file" name="karya_tulis" id="karya_tulis"
                                            class="form-control-file @error('karya_tulis') is-invalid @enderror" required>
                                        @error('karya_tulis')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-12 col-lg-12">
                                        ...
                                        <textarea class="form-control @error('prestasi') is-invalid @enderror" id="prestasi" name="prestasi" required></textarea>
                                        @error('prestasi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
